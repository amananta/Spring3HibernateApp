package com.javaMVC.controller;
...
import com.javaMVC.bean.EmployeeBean;
import com.javaMVC.bean.LoginBean;
import com.javaMVC.model.Employee;
import com.javaMVC.service.EmployeeService;
...
public class EmployeeController {
	...
	public ModelAndView loginEmployees(@ModelAttribute("command") LoginBean loginBean, 
			BindingResult result) {
		
	return new ModelAndView("Employee_cred");
	}
	
	@RequestMapping(value = "/loginSubmit", method = RequestMethod.POST)
	public ModelAndView checkEmployee(@ModelAttribute("command") LoginBean loginBean, 
			BindingResult result) {
		
		return new ModelAndView("welcome_user");
